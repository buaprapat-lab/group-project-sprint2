    ...
    <section className="flex flex-col gap-6 sticky top-10">
      ...
      <div className="bg-brand-orange p-6 rounded shadow-md flex flex-wrap justify-center sm:justify-start items-center gap-4">
        <div className="flex flex-col w-full sm:w-auto">
          <label className="font-black text-brand-white uppercase tracking-wider text-sm mb-1">
            Date
          </label>
          <input
            type="date"
            ...
            onChange={(e) =>
              setOrderState({ ...orderState, date: e.target.value })
            }
        ...
        {showTime && (
          <div className="flex flex-col w-full sm:w-auto flex-1">
            ...
            <select
              ...
              onChange={(e) =>
                setOrderState({ ...orderState, time: e.target.value })
              }
              className="text-brand-black font-semibold p-2 rounded bg-brand-white focus:outline-none w-full"
            >
        ...
        {showMember && (
          <div className="flex flex-col w-full sm:w-auto">
            ...
            <select
              ...
              onChange={(e) =>
                setOrderState({ ...orderState, member: e.target.value })
              }
              className="text-brand-black font-semibold p-2 rounded bg-brand-white focus:outline-none w-full"
            >
      ...
      <div className="bg-white border-2 border-brand-black p-6 rounded shadow-lg">
        <h3 className="text-xl font-black uppercase tracking-widest mb-6 text-brand-black text-center border-b-2 border-brand-gray pb-2">
          Booking Information
        </h3>
        ...
        <div className="text-left text-base font-black uppercase space-y-4 text-brand-black">
          ...
          <p className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 border-b border-brand-gray pb-2">
            ...
            {isEditing ? (
              <select
                ...
                onChange={(e) =>
                  setEditOrder({ ...editOrder, type: e.target.value })
                }
          ...
          <p className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 border-b border-brand-gray pb-2">
            ...
            <span className="font-bold">
              {formatDisplayDate(orderState.date)} ({orderState.time})
            </span>
          </p>
          ...
          <p className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 border-b border-brand-gray pb-2">
            ...
            {isEditing ? (
              <input
                ...
                className="font-bold border-b-2 border-brand-black text-right w-1/2 bg-transparent"
              />
            ) : (
            ...
            <p className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 border-b border-brand-gray pb-2">
              ...
              {isEditing ? (
                <select
                  ...
                  onChange={(e) =>
                    setEditOrder({ ...editOrder, member: e.target.value })
                  }
                  className="font-bold border-b-2 border-brand-black text-right bg-transparent w-1/2"
                >
          ...
          <p className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 border-b border-brand-gray pb-2">
            ...
            {isEditing ? (
              <input
                ...
                className="font-bold lowercase border-b-2 border-brand-black text-right w-1/2 bg-transparent"
              />
            ) : (
          ...
          <p className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-1 border-b border-brand-gray pb-2">
            ...
            {isEditing ? (
              <input
                ...
                onChange={(e) =>
                  setEditProfile({ ...editProfile, contact: e.target.value })
                }
                className="font-bold border-b-2 border-brand-black text-right w-1/2 bg-transparent"
              />
            ) : (
      ...
      <div className="bg-brand-black flex justify-between items-center p-4 rounded shadow-md text-sm sm:text-base font-black uppercase tracking-widest mt-2">
        <div>
          {isEditing ? (
            <button
              ...
              className="text-brand-orange hover:opacity-90 transition px-2 py-2 flex items-center gap-2"
            >
              💾 UPDATE
            </button>
          ) : (
        ...
        <button
          ...
          className="text-brand-red hover:opacity-80 transition px-2 py-2"
        >
          Cancel
        </button>
      </div>
